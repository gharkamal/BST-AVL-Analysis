...
/**
 * I made this class separate for PerformanceChecker class to avoid printing the messages
 * the messages make the output too cluttered.
 */
public class AVLTree2<T extends Comparable<Integer>> extends
